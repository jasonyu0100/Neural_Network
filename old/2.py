...
def main():
  #Network Information
  nn = Network([Layer(2,activation_function=leaky_relu,input_size=1),
                Layer(2,activation_function=sigmoid)],
                network_type='classification')
  #Mock Data
  #Age as input
  #If over 50, 90% to not have illness
  #If under 50, 90% to have illness
  ...
  training_set = data
  valid_set = data
  testing_set = valid_set
  # print(training_set)

  # Training and Evaluation
  # nn.evaluate_network(testing_set)
  nn.show_weights()
  nn.train_network(training_set,valid_set,learning_rate=0.001,epochs=1000,batch_size=1,display_epoch=10)
  nn.show_weights()
  # nn.evaluate_network(testing_set)
